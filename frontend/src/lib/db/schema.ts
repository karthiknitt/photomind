...
// ─── face_cluster_pairs ───────────────────────────────────────────────────────
// Records confirmed same/different decisions between clusters.
...
export type FaceClusterPair = typeof faceClusterPairs.$inferSelect;
export type NewFaceClusterPair = typeof faceClusterPairs.$inferInsert;
